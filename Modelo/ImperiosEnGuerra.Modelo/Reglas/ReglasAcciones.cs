...
{
    /// <summary>
    /// Reglas de seleccion y objetivos. Vive en el Modelo.
    /// El Controlador Unity solo actua como puente y debe consultar aqui
    /// (via API interna) en lugar de duplicar strings de dominio.
    /// </summary>
    public static class ReglasAcciones
    {
        ...
        /// <summary>
        /// Ejecuta la operacion es unidad militar.
        /// </summary>
        ...
        /// <summary>
        /// Las ordenes son interrumpibles: una unidad ocupada puede recibir
        ...
        /// <summary>
        /// Ejecuta la operacion permite recolectar.
        /// </summary>
        ...
        /// <summary>
        /// Ejecuta la operacion permite construir.
        /// </summary>
        /// <param name="propietario">El valor de propietario.</param>
        /// <param name="categoria">El valor de categoria.</param>
        /// <param name="tipoLogico">El valor de tipo logico.</param>
        ...
        /// <summary>
        /// Ejecuta la operacion permite entrenar.
        /// </summary>
        /// <param name="propietario">El valor de propietario.</param>
        /// <param name="categoria">El valor de categoria.</param>
        /// <param name="tipoLogico">El valor de tipo logico.</param>
        ...
        /// <summary>
        /// Ejecuta la operacion permite atacar.
        /// </summary>
        /// <param name="propietario">El valor de propietario.</param>
        /// <param name="categoria">El valor de categoria.</param>
        /// <param name="tipoLogico">El valor de tipo logico.</param>
        ...
        /// <summary>
        /// Ejecuta la operacion es objetivo ataque valido.
        /// </summary>
        /// <param name="categoria">El valor de categoria.</param>
        /// <param name="propietario">El valor de propietario.</param>
